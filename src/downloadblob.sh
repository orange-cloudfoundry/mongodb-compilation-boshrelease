curl --connect-timeout 10 -w 200 --retry 5 -o cmake-3.11.4.tar.gz -L https://cmake.org/files/v3.11/cmake-3.11.4.tar.gz
...
curl --connect-timeout 10 -w 200 --retry 5 -o scons-3.0.1.tar.gz -L http://prdownloads.sourceforge.net/scons/scons-3.0.1.tar.gz
...
curl --connect-timeout 10 -w 200 --retry 5 -o automake-1.16.tar.gz -L https://ftp.gnu.org/gnu/automake/automake-1.16.tar.gz
