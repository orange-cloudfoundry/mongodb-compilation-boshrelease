...
#binutils
curl --connect-timeout 10 -w 200 --retry 5 -o binutils-2.31.1.tar.gz -L https://ftp.gnu.org/gnu/binutils/binutils-2.31.1.tar.gz
curl --connect-timeout 10 -w 200 --retry 5 -o lzip-1.20.tar.gz -L http://download.savannah.gnu.org/releases/lzip/lzip-1.20.tar.gz
...
#compilation tools
curl --connect-timeout 10 -w 200 --retry 5 -o cmake-3.13.1.tar.gz -L https://github.com/Kitware/CMake/archive/v3.13.1.tar.gz
...
curl --connect-timeout 10 -w 200 --retry 5 -o git-2.19.2.tar.gz -L https://github.com/git/git/archive/v2.19.2.tar.gz
...
#coreutils
curl --connect-timeout 10 -w 200 --retry 5 -o coreutils-8.30.tar.xz -L https://ftp.gnu.org/gnu/coreutils/coreutils-8.30.tar.xz
...
curl --connect-timeout 10 -w 200 --retry 5 -o mpfr-3.1.6.tar.bz2 -L https://ftp.gnu.org/gnu/mpfr/mpfr-4.0.1.tar.bz2
...
#openssl
curl --connect-timeout 10 -w 200 --retry 5 -o openssl-1.0.2q.tar.gz -L https://www.openssl.org/source/openssl-1.0.2q.tar.gz
